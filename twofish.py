...
#Testin için "1234123412341234" metni ve "1234123412341234" anahtarı kullanılmıştır
...
data = bytearray(input("metin giriniz (16nın katları uzunluğunda olmalı): "), "ascii")
key = bytearray(input("anahtar giriniz (16 24 yada 32 uzunluğunda olmalı): "), "ascii")


if input("Şifrelemek için 1, Şifre çözmek için 0 yazın: ")=="1":
    Time = time.perf_counter()
    print(Twofish(key).encrypt(data))
else:
    Time = time.perf_counter()
    print(Twofish(key).decrypt(data))
